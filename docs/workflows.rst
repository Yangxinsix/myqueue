...
We put the three Python files in a ``prime/`` folder::
    ...
    $ ls -l prime/
    total 12
    -rw-rw-r-- 1 jensj jensj 190 Oct 27 15:26 check.py
    -rw-rw-r-- 1 jensj jensj 387 Oct 27 15:26 factor.py
    -rw-rw-r-- 1 jensj jensj 166 Oct 27 15:26 workflow.py
...
and now in all subfolders::
    ...
    4  ./100007/ prime.check  d1 1:10m
    5  ./36791/  prime.factor    1:10m
    6  ./36791/  prime.check  d1 1:10m
    7  ./8069/   prime.factor    1:10m
    8  ./8069/   prime.check  d1 1:10m
    9  ./98769/  prime.factor    1:10m
    10 ./98769/  prime.check  d1 1:10m
    11 ./99/     prime.factor    1:10m
    12 ./99/     prime.check  d1 1:10m
    10 tasks submitted
...
``prime.check`` task has been completed::
    ...
    $ ls -l 1001/
    total 4
    -rw-rw-r-- 1 jensj jensj 24 Oct 27 15:26 factors.json
    -rw-rw-r-- 1 jensj jensj  0 Oct 27 15:26 prime.check.2.err
    -rw-rw-r-- 1 jensj jensj  0 Oct 27 15:26 prime.check.2.out
    -rw-rw-r-- 1 jensj jensj  0 Oct 27 15:26 prime.check.done
    -rw-rw-r-- 1 jensj jensj  0 Oct 27 15:26 prime.factor.1.err
    -rw-rw-r-- 1 jensj jensj  0 Oct 27 15:26 prime.factor.1.out
